...
return [
    ...
    'types' => [
        '0' => [
            'showitem' => 'sys_language_uid, pid, url, user_agent, operating_system, bot, type, crdate',
        ],
    ],
    'columns' => [
        'pid' => [
        ...
        'bot' => [
            'label' => 'LLL:EXT:tracking/Resources/Private/Language/locallang_tca.xlf:table.pageview.bot',
            'config' => [
                'type' => 'input',
                'readOnly' => true,
            ],
